...
//           <div
//             className={`
//               absolute top-1 h-8 w-16 bg-white rounded-full shadow-md transition-all duration-300
//               ${view === "card" ? "left-1" : "left-19"}
//             `}
//             style={{
...
//           {/* Card side */}
//           <div className="flex-1 flex items-center justify-center gap-1 z-10">
//             <span
//               className={`text-sm font-medium ${
//                 view === "card" ? "text-blue-600" : "text-gray-600"
//               }`}
//             >
//               Card
//             </span>
...
//             <span
//               className={`text-sm font-medium ${
//                 view === "table" ? "text-blue-600" : "text-gray-600"
//               }`}
//             >
//               Table
//             </span>
...
//                   <td className="p-3 text-sm">{c.industry}</td>
//                   <td className="p-3 text-sm">{c.location}</td>
//                   <td className="p-3 text-sm">{c.employees}</td>
//                 </tr>
//               ))}
//             </tbody>
//           </table>
